...
'''
#testing Cell
cont = Container("Container",250)
cellTest = Space(3,2)
print("Height:" , cellTest.height)
print("width:" , cellTest.width)
count = 0

print(cellTest.cells)
cellTest.addContainer(1,1,cont)

print(cellTest.cells[1][1].getState())
#print(cellTest.getCellState(1,1))
...
for i in range(4):
    ...
    shipLoad.append(hullSpot2)
    allContainers.append(Container("Container Ld " + str(i), 100+i))
    containerSpot = (Cell(container = allContainers[-1]), Coordinate(1, 8-i))
    shipLoad.append(containerSpot)

allContainers.append(Container("Container to Offload", 420, True))
toAdd = (Cell(container = allContainers[-1]), Coordinate(2, 8))
shipLoad.append(toAdd)

toLoad = []
toLoad.append(Container("From truck 1", 100))
toLoad.append(Container("From truck 2", 200))
...
for i in shipLoad:
    a = i[0]
    print(a.getContainer())
    if(a.getContainer() != None):
        print(a.getContainer().getDescription())
